...
function revslider_showDoubleJqueryError(e) {
    ...
    function n(n, i) {
        ...
        if (!n.hasClass("revslider-initialised")) {
            ...
            if (i.slideamount > 1 && i.navigationStyle == "thumb") tt(n, i);
    ...
    var B = function(n, r, i) {
        ...
        if (a.length > 0) u.push(a);
        u.each(function(n) {
            var u = -1;
            var a = e(this);
            if (a.hasClass("tp-static-layer")) {
                if (!a.hasClass("tp-is-shown")) {
                    if (a.data("startslide") <= r.next && a.data("endslide") >= r.next || a.data("startslide") == r.next || a.data("endslide") == r.next) {
                        a.addClass("tp-is-shown");
                        u = 1
                    } else {
                        u = 0
                    }
                } else {
                    if (a.data("endslide") == r.next || a.data("startslide") > r.next || a.data("endslide") < r.next) {
                        u = 2;
                        a.removeClass("tp-is-shown")
                    } else {
                        u = 0
                    }
                }
            ...
            if (r.width < r.hideCaptionAtLimit && a.data("captionhidden") == "on") {
                ...
                if (a.data("linktoslide") != t && !a.hasClass("hasclicklistener")) {
                    a.addClass("hasclicklistener");
                    a.css({
                        cursor: "pointer"
                    });
                ...
                if (a.find("iframe").length > 0 || a.find("video").length > 0) {
                    if (a.data("autoplayonlyfirsttime") == true || a.data("autoplayonlyfirsttime") == "true") {
                    ...
                    a.find("iframe").each(function() {
                        ...
                        r.nextslideatend = a.data("nextslideatend");
                        if (a.data("thumbimage") != t && a.data("thumbimage").length > 2 && a.data("autoplay") != true && !i) {
                            a.find(".tp-thumb-image").remove();
                            a.append('<div class="tp-thumb-image" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;background-image:url(' + a.data("thumbimage") + '); background-size:cover"></div>')
                        }
                        if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                            if (!n.hasClass("HasListener")) {
                                ...
                                if (a.data("autoplay") == true) {
                                    var o = a.data("player");
                                    a.data("timerplay", setTimeout(function() {
                                        if (a.data("forcerewind") == "on") o.seekTo(0);
                                        o.playVideo()
                                    }, a.data("start")))
                                }
                            }
                            ...
                            if (n.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                                if (!n.hasClass("HasListener")) {
                                    ...
                                    if (c["player_id"] != t) l = l.replace(c["player_id"], h);
                                    else l = l + "&player_id=" + h;
                                    try {
                                    ...
                                    if (a.data("autoplay") == true) {
                                        ...
                                        var m = setInterval(function() {
                                            if ($f != t)
                                                if (typeof $f(g).api != t && typeof $f(g).api != "undefined") {
                                                    var e = $f(g);
                                                    a.data("timerplay", setTimeout(function() {
                                                        if (a.data("forcerewind") == "on") e.api("seekTo", 0);
                                                        e.api("play")
                                                    }, a.data("start")));
                                                    clearInterval(m)
                                                }
                        ...
                        a.find("video").each(function(n) {
                            ...
                            if (s.addEventListener) s.addEventListener("loadedmetadata", function() {
                                ...
                                s.addEventListener("play", function() {
                                    ...
                                    if (a.data("volume") == "mute") s.muted = true;
                            ...
                            if (a.data("forcecover") == 1) {
                                _(o, r.container);
                                o.addClass("fullcoveredvideo");
                                a.addClass("fullcoveredvideo")
                            }
                            if (a.data("forcecover") == 1 || a.hasClass("fullscreenvideo")) {
                                o.css({
                                    width: "100%",
                                    height: "100%"
                                })
                            ...
                            var u = false;
                            if (a.data("autoplayonlyfirsttime") == true || a.data("autoplayonlyfirsttime") == "true") u = true;
                            clearInterval(o.data("interval"));
                            o.data("interval", setInterval(function() {
                                if (o.data("metaloaded") == 1 || s.duration != NaN) {
                                    clearInterval(o.data("interval"));
                                    if (a.data("dottedoverlay") != "none" && a.data("dottedoverlay") != t)
                                        if (a.find(".tp-dottedoverlay").length != 1) o.append('<div class="tp-dottedoverlay ' + a.data("dottedoverlay") + '"></div>');
                                    var n = 16 / 9;
                                    if (a.data("aspectratio") == "4:3") n = 4 / 3;
                                    ...
                                    r.nextslideatend = a.data("nextslideatend");
                                    if (a.data("autoplay") == true || u == true) {
                                        var f = e("body").find("#" + r.container.attr("id")).find(".tp-bannertimer");
                                        setTimeout(function() {
                                            r.videoplaying = true;
                                            r.container.trigger("stoptimer")
                                        }, 200);
                                        if (a.data("forcerewind") == "on" && !o.hasClass("videoisplaying"))
                                    ...
                                    if (!a.hasClass("fullscreenvideo") && a.data("forcecover") == 1) {
                                        try {
                    ...
                    if (a.data("autoplay") == true) {
                        ...
                        if (a.data("autoplayonlyfirsttime") == true || a.data("autoplayonlyfirsttime") == "true") {
                            ...
                            a.data("autoplayonlyfirsttime", false)
                        }
                    }
                }
                var d = 0;
                ...
                if (a.find("img").length > 0) {
                    ...
                    if (a.find("iframe").length > 0 || a.find("video").length > 0) {
                        ...
                        if (a.data("ww") == t) a.data("ww", m.width());
                        if (a.data("hh") == t) a.data("hh", m.height());
                        var g = a.data("ww");
                        var y = a.data("hh");
                        var w = a;
                        ...
                        if (!a.hasClass("fullscreenvideo")) a.css({
                            ...
                            m.width(g * r.bw);
                            m.height(y * r.bh)
                        } else if (a.data("forcecover") != 1 && !a.hasClass("fullscreenvideo")) {
                            m.width(g * r.bw);
                            m.height(y * r.bh)
                        }
                        d = m.width();
                        ...
                        if (a.hasClass("tp-resizeme")) {
                            a.find("*").each(function() {
                                I(e(this), r)
                            })
                        }
                        I(a, r);
                        v = a.outerHeight(true);
                        d = a.outerWidth(true);
                        var T = a.outerHeight();
                        var N = a.css("backgroundColor");
                        a.find(".frontcorner").css({
                            borderWidth: T + "px",
                            left: 0 - T + "px",
                            borderRight: "0px solid transparent",
                            borderTopColor: N
                        });
                        a.find(".frontcornertop").css({
                            borderWidth: T + "px",
                            left: 0 - T + "px",
                            borderRight: "0px solid transparent",
                            borderBottomColor: N
                        });
                        a.find(".backcorner").css({
                            borderWidth: T + "px",
                            right: 0 - T + "px",
                            borderLeft: "0px solid transparent",
                            borderBottomColor: N
                        });
                        a.find(".backcornertop").css({
                            borderWidth: T + "px",
                            right: 0 - T + "px",
                            borderLeft: "0px solid transparent",
                            borderTopColor: N
                ...
                if (a.data("voffset") == t) a.data("voffset", 0);
                if (a.data("hoffset") == t) a.data("hoffset", 0);
                var C = a.data("voffset") * f;
                var k = a.data("hoffset") * f;
                var L = r.startwidth * f;
                var O = r.startheight * f;
                if (r.fullScreenAlignForce == "on") {
                    L = r.container.width();
                ...
                if (a.data("x") == "center" || a.data("xcenter") == "center") {
                    ...
                    a.data("x", L / 2 - a.outerWidth(true) / 2 + k)
                }
                if (a.data("x") == "left" || a.data("xleft") == "left") {
                    a.data("xleft", "left");
                    a.data("x", 0 / f + k)
                }
                if (a.data("x") == "right" || a.data("xright") == "right") {
                    a.data("xright", "right");
                    a.data("x", (L - a.outerWidth(true) + k) / f)
                }
                if (a.data("y") == "center" || a.data("ycenter") == "center") {
                    a.data("ycenter", "center");
                    a.data("y", O / 2 - a.outerHeight(true) / 2 + C)
                }
                if (a.data("y") == "top" || a.data("ytop") == "top") {
                    a.data("ytop", "top");
                    a.data("y", 0 / r.bh + C)
                }
                if (a.data("y") == "bottom" || a.data("ybottom") == "bottom") {
                    a.data("ybottom", "bottom");
                    a.data("y", (O - a.outerHeight(true) + C) / f)
                }
                if (a.data("start") == t) a.data("start", 1e3);
                var B = a.data("easing");
                if (B == t) B = "Power1.easeOut";
                var F = a.data("start") / 1e3;
                var U = a.data("speed") / 1e3;
                if (a.data("x") == "center" || a.data("xcenter") == "center") var X = a.data("x") + s;
                else {
                    var X = f * a.data("x") + s
                } if (a.data("y") == "center" || a.data("ycenter") == "center") var V = a.data("y") + o;
                else {
                    var V = r.bh * a.data("y") + o
                }
                TweenLite.set(a, {
                    top: V,
                    left: X,
                ...
                if (u == 0) i = true;
                if (!i) {
                    if (a.data("timeline") != t) a.data("timeline").clear();
                    ...
                    if (r.fullScreenAlignForce == "on") {}
                    var G = a;
                    if (a.data("mySplitText") != t) a.data("mySplitText").revert();
                    if (a.data("splitin") == "chars" || a.data("splitin") == "words" || a.data("splitin") == "lines" || a.data("splitout") == "chars" || a.data("splitout") == "words" || a.data("splitout") == "lines") {
                        if (a.find("a").length > 0) a.data("mySplitText", new SplitText(a.find("a"), {
                            type: "lines,words,chars",
                            charsClass: "tp-splitted",
                            wordsClass: "tp-splitted",
                            linesClass: "tp-splitted"
                        }));
                        else a.data("mySplitText", new SplitText(a, {
                            type: "lines,words,chars",
                            charsClass: "tp-splitted",
                            wordsClass: "tp-splitted",
                            linesClass: "tp-splitted"
                    ...
                    if (a.data("splitin") == "chars") G = a.data("mySplitText").chars;
                    if (a.data("splitin") == "words") G = a.data("mySplitText").words;
                    if (a.data("splitin") == "lines") G = a.data("mySplitText").lines;
                    var Y = D();
                    var Z = D();
                    if (a.data("repeat") != t) repeatV = a.data("repeat");
                    if (a.data("yoyo") != t) yoyoV = a.data("yoyo");
                    if (a.data("repeatdelay") != t) repeatdelayV = a.data("repeatdelay");
                    if (a.hasClass("customin")) Y = P(Y, a.data("customin"));
                    else if (a.hasClass("randomrotate")) {
                        Y.scale = Math.random() * 3 + 1;
                        Y.rotation = Math.round(Math.random() * 200 - 100);
                        Y.x = Math.round(Math.random() * 200 - 100);
                        Y.y = Math.round(Math.random() * 200 - 100)
                    } else if (a.hasClass("lfr") || a.hasClass("skewfromright")) Y.x = 15 + r.width;
                    else if (a.hasClass("lfl") || a.hasClass("skewfromleft")) Y.x = -15 - d;
                    else if (a.hasClass("sfl") || a.hasClass("skewfromleftshort")) Y.x = -50;
                    else if (a.hasClass("sfr") || a.hasClass("skewfromrightshort")) Y.x = 50;
                    else if (a.hasClass("lft")) Y.y = -25 - v;
                    else if (a.hasClass("lfb")) Y.y = 25 + r.height;
                    else if (a.hasClass("sft")) Y.y = -50;
                    else if (a.hasClass("sfb")) Y.y = 50;
                    if (a.hasClass("skewfromright") || a.hasClass("skewfromrightshort")) Y.skewX = -85;
                    else if (a.hasClass("skewfromleft") || a.hasClass("skewfromleftshort")) Y.skewX = 85;
                    if (a.hasClass("fade") || a.hasClass("sft") || a.hasClass("sfl") || a.hasClass("sfb") || a.hasClass("skewfromleftshort") || a.hasClass("sfr") || a.hasClass("skewfromrightshort")) Y.opacity = 0;
                    if (j().toLowerCase() == "safari") {
                        Y.rotationX = 0;
                        Y.rotationY = 0
                    }
                    var et = a.data("elementdelay") == t ? 0 : a.data("elementdelay");
                    Z.ease = Y.ease = a.data("easing") == t ? Power1.easeInOut : a.data("easing");
                    Y.data = new Object;
                    Y.data.oldx = Y.x;
                    Y.data.oldy = Y.y;
                    Z.data = new Object;
                    ...
                    if (u != 2) {
                        if (a.hasClass("customin")) {
                            if (G != a) Q.add(TweenLite.set(a, {
                                opacity: 1,
                                scaleX: 1,
                                scaleY: 1,
                                rotationX: 0,
                            ...
                            Z.onComplete = J();
                            Z.delay = F;
                            Q.add(tt.staggerFromTo(G, U, Y, Z, et), "frame0")
                        } else {
                            Y.visibility = "visible";
                            Y.transformPerspective = 600;
                            if (G != a) Q.add(TweenLite.set(a, {
                                opacity: 1,
                                scaleX: 1,
                                scaleY: 1,
                            ...
                            Z.onComplete = J();
                            Z.opacity = 1;
                            if (a.hasClass("randomrotate") && G != a) {
                                for (var n = 0; n < G.length; n++) {
                                    ...
                                    Y.x = Math.round(Math.random() * 200 - 100);
                                    Y.y = Math.round(Math.random() * 200 - 100);
                                    if (n != 0) rt.delay = F + n * et;
                                    Q.append(TweenLite.fromTo(G[n], U, nt, rt), "frame0")
                                }
                            } else Q.add(tt.staggerFromTo(G, U, Y, Z, et), "frame0")
                        }
                    }
                    a.data("timeline", Q);
                    var it = new Array;
                    if (a.data("frames") != t) {
                        var st = a.data("frames");
                        st = st.replace(/\s+/g, "");
                        st = st.replace("{", "");
                        var ot = st.split("}");
                        e.each(ot, function(e, t) {
                            if (t.length > 0) {
                                var n = H(t);
                                z(a, r, n, "frame" + (e + 10), f)
                            }
                        })
                    }
                    Q = a.data("timeline");
                    if (a.data("end") != t && (u == -1 || u == 2)) {
                        W(a, r, a.data("end") / 1e3, Y, "frame99", f)
                    } else {
                        W(a, r, 999999, Y, "frame99", f)
                    }
                    Q = a.data("timeline");
                    a.data("timeline", Q);
                    q(a, f)
            ...
            if (i) {
                R(a);
                q(a, f);
                if (a.data("timeline") != t) {
                    var ut = a.data("timeline").getTweensOf();
                    e.each(ut, function(e, n) {
                        if (n.vars.data != t) {
                            var r = n.vars.data.oldx * f;
                            var i = n.vars.data.oldy * f;
    ...
    var U = function(n, r) {
        ...
        n.find(".tp-caption").each(function(n) {
            ...
            try {
                var l = r.data("timeline");
                var c = l.getLabelTime("frame99");
                var h = l.time();
                if (c > h) {
                    var p = l.getTweensOf(r);
                    e.each(p, function(e, t) {
                        if (e != 0) t.pause()
                    });
                    if (r.css("opacity") != 0) {
                        var d = r.data("endspeed") == t ? r.data("speed") : r.data("endspeed");
                        if (d > i) i = d;
                        l.play("frame99")
                    } else l.progress(1, false)
                }
            } catch (a) {}
        });
        return i
...
(function(e) {
    ...
    var t = e.GreenSockGlobals || e,
        ...
        o = s.defaultView ? s.defaultView.getComputedStyle : function() {}, u = /([A-Z])/g,
        a = function(e, t, n, r) {
            var i;
